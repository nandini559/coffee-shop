...
export default function ContactSection({ onOpenReservation }) {
  ...
  return (
    <section id="contact" className="py-12 sm:py-16 bg-transparent text-[#2C1A14] dark:text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 grid-rows-1 sm:grid-rows-2 gap-3.5 sm:gap-4 h-full">
            ...
            <div className="glass-card h-full p-4 sm:p-5 rounded-2xl border border-[#E5DCD3] dark:border-coffee-800 shadow-lg flex flex-col justify-between transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5">
              ...
              <button
                ...
                className="w-full py-2 rounded-lg bg-[#2C1A14] dark:bg-[#C67C4E] hover:bg-[#3D291F] dark:hover:bg-[#A35D31] text-white dark:text-[#160F0B] font-extrabold text-[11px] uppercase tracking-wider shadow-sm flex items-center justify-center gap-1.5 transition mt-3"
              >
          ...
          <div className="h-full">
            <div className="glass-card h-full p-4 sm:p-5 rounded-2xl border border-[#E5DCD3] dark:border-coffee-800 shadow-lg flex flex-col justify-between">
              ...
              <button
                type="submit"
                form="contact-form"
                className="w-full py-2.5 rounded-lg bg-[#2C1A14] dark:bg-[#C67C4E] hover:bg-[#3D291F] dark:hover:bg-[#A35D31] text-white dark:text-[#160F0B] font-extrabold text-xs uppercase tracking-wider shadow-sm flex items-center justify-center gap-1.5 transition mt-3"
              >
