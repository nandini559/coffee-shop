...
export default function ContactSection({onOpenReservation}) {
  ...
  return (<section id="contact" className="py-20 sm:py-24 lg:py-28 bg-transparent text-[#2C1A14] dark:text-white relative overflow-hidden">
        ...
        <div className="lg:col-span-5 glass-card p-3 sm:p-5 rounded-3xl border border-[#E5DCD3] dark:border-coffee-800 space-y-3 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
...
} className="w-full px-4 py-2.5 rounded-xl bg-white/90 dark:bg-[#160F0B]/90 border border-[#E5DCD3] dark:border-coffee-800 text-[#2C1A14] dark:text-white text-xs font-medium focus:border-[#C67C4E] focus:outline-none"/>
            </div>
            ...
            <div>
              ...
              <textarea rows={3} required="required" placeholder="How can we assist you today?" value={formData.message} onChange={e => setFormData(prev => ({
                  ...prev,
            ...
            <button type="submit" className="w-full py-3 rounded-xl bg-[#2C1A14] dark:bg-[#C67C4E] hover:bg-[#3D291F] dark:hover:bg-[#A35D31] text-white dark:text-[#160F0B] font-extrabold text-xs uppercase tracking-wider shadow-md flex items-center justify-center gap-2">
