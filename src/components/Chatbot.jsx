...
//             <motion.button
//   ...
//   className="p-2.5 rounded-full bg-[#2C1A14] dark:bg-[#C67C4E] text-white shadow-lg hover:bg-[#3D291F] transition"
// >
...
//   target="_blank"
//   rel="noreferrer"
//   className="p-2.5 rounded-full bg-[#25D366] hover:bg-[#20ba59] text-white shadow-lg transition"
