      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-center">
        ...
        <motion.div initial={{
          ...
          <div className="pt-2 flex items-center gap-4">
            ...
            <button onClick={onOpenReservation} className="px-5 py-3.5 text-xs font-extrabold uppercase tracking-wider text-[#5C4337] dark:text-coffee-300 hover:text-[#2C1A14] dark:hover:text-white transition">
              Reserve Table &rarr;
            </button>
          </div>
        </motion.div>
