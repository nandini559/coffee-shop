      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        >
          ...
          >
            ...
            <svg
              className="w-6 h-6 text-[#FDFBF7] relative z-10 filter drop-shadow-sm"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
            ...
            >
              ...
              <path d="M12 2c.5 1 1.5 1.5 1.5 2.5s-1 1.5-.5 2.5" className="animate-pulse" stroke="#F0C085" strokeWidth="1.5" style={{ animationDelay: "300ms" }} />
              <path d="M18 3c.5 1 1.5 1.5 1.5 2.5s-1 1.5-.5 2.5" className="animate-pulse" stroke="#F0C085" strokeWidth="1.5" style={{ animationDelay: "600ms" }} />
        ...
        <nav className="hidden md:flex items-center gap-12">
          {navLinks.map((link, index) => (
            <a
              ...
              className={`relative text-[10px] font-extrabold uppercase tracking-wider transition-all duration-300 cursor-pointer ${
                scrolled
        ...
        <div className="flex items-center gap-2.5">
          ...
          <motion.button
            ...
            className="relative px-4 py-2.5 rounded-xl bg-[#2C1A14] dark:bg-[#C67C4E] text-white dark:text-[#160F0B] font-extrabold text-xs uppercase tracking-wider shadow-sm flex items-center gap-2 cursor-pointer touch-manipulation"
          >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#FDFBF7] dark:bg-[#160F0B] border-b border-[#E5DCD3] dark:border-coffee-800 px-6 py-6 space-y-4 shadow-xl"
          >
            {navLinks.map((link) => (
              <a
                key={link.name}
                ...
                className="block text-sm font-extrabold uppercase tracking-wider text-[#2C1A14] dark:text-coffee-100 hover:text-[#C67C4E] py-1 cursor-pointer touch-manipulation"
              >
                {link.name}
              </a>
            ))}
