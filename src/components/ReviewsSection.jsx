...
export default function ReviewsSection() {
  ...
  return (<section id="reviews" className="py-24 bg-gradient-to-b from-[#FFFDF9] via-[#F4ECE1] to-[#E8DCCF] dark:from-[#160F0B] dark:via-[#20150F] dark:to-[#160F0B] text-[#2C1A14] dark:text-white relative overflow-hidden">
            ...
            return (<motion.div key={rev.id} initial={{
              ...
              <div className="pt-4 border-t border-[#2C1A14]/15 flex items-center justify-between gap-3">
                <div className="flex items-center gap-2.5">
                  <img src={rev.avatar} alt={rev.name} className="w-9 h-9 rounded-full object-cover border-2 border-[#2C1A14]/30 shadow-xs"/>
                  <div>
                    <div className="flex items-center gap-1">
                      <span className="font-handwritten text-lg font-bold text-[#2C1A14] leading-none">
                        {rev.name}
                      </span>
                      {rev.verified && (<CheckCircle2 className="w-3.5 h-3.5 text-emerald-700"/>)}
                    </div>
                ...
                <span className="text-[10px] font-bold text-[#855E4C] italic">
                  {rev.date}
                </span>
              </div>
            </motion.div>);
