export const CATEGORIES = [
  { id: 'all', name: 'All Brews & Bites', icon: 'Sparkles' },
  { id: 'espresso', name: 'Espresso & Classics', icon: 'Coffee' },
  { id: 'cold-brew', name: 'Cold Brew & Iced', icon: 'Zap' },
  { id: 'matcha-tea', name: 'Artisanal Teas & Matcha', icon: 'Leaf' },
  { id: 'bakery', name: 'Pastries & Bakery', icon: 'Cookie' },
  { id: 'vegan', name: 'Vegan & Plant-Based', icon: 'Heart' },
];
...
export const MENU_ITEMS = [
  {
    ...
    ingredients: ['Ethiopian Single Origin Espresso', 'Organic Oat Milk', 'House-made Salted Caramel', 'Madagascar Vanilla Bean'],
    allergens: ['None (Dairy-free on request)'],
    tags: ['Best Seller', 'Signature', 'Dairy-Free Option'],
    calories: 210,
    prepTime: '3-4 mins',
    popular: true,
  ...
  },
  {
    ...
    ingredients: ['20-Hr Cold Brew Blend', 'Nitrogen Infusion', 'French Lavender Syrup', 'Sweet Cream Cold Foam'],
    allergens: ['Dairy (Foam)'],
    tags: ['Cold Brew', 'Customer Favorite', 'Low Calorie Base'],
    calories: 140,
    prepTime: '2 mins',
    popular: true,
  ...
  },
  {
    ...
    ingredients: ['Ristretto Blend Espresso', 'Barista Oat Milk', 'Touch of Cinnamon Dust'],
    allergens: ['Gluten (Oat)'],
    tags: ['Vegan', 'Sugar-Free', 'Classic'],
    calories: 130,
    prepTime: '3 mins',
    popular: false,
  ...
  },
  {
    ...
    ingredients: ['Uji Ceremonial Matcha', 'Unsweetened Almond Milk', 'Raw Honey', 'Vanilla Bean Paste'],
    allergens: ['Tree Nuts (Almond)'],
    tags: ['Antioxidant-Rich', 'Organic', 'Superfood'],
    calories: 110,
    prepTime: '4 mins',
    popular: true,
  ...
  },
  {
    ...
    ingredients: ['Espresso Blend', 'Condensed Whole Milk', 'Bourbon Vanilla Bean', 'Valrhona Cocoa Powder'],
    allergens: ['Dairy'],
    tags: ['Sweet & Rich', 'Chef Choice'],
    calories: 260,
    prepTime: '3 mins',
    popular: true,
  ...
  },
  {
    ...
    ingredients: ['Espresso', 'Belgian Dark Chocolate (70%)', 'Whole Milk', 'Whipped Cream', 'Dark Chocolate Shavings'],
    allergens: ['Dairy', 'Soy (Chocolate)'],
    tags: ['Indulgent', 'Iced Blended'],
    calories: 340,
    prepTime: '4 mins',
    popular: false,
  ...
  },
  {
    ...
    ingredients: ['Normandy Butter', 'French T55 Flour', 'Organic Cane Sugar', 'Sea Salt'],
    allergens: ['Gluten', 'Dairy'],
    tags: ['Freshly Baked', 'Classic French', 'Top Morning Pick'],
    calories: 280,
  ...
  },
  {
    ...
    ingredients: ['Sicilian Pistachio Paste', 'Green Cardamom', 'Puff Pastry', 'Rose Petal Dust'],
    allergens: ['Gluten', 'Dairy', 'Tree Nuts (Pistachio)'],
    tags: ['Gourmet Pastry', 'Chef Special'],
    calories: 320,
    prepTime: 'Instant / Warmed 1 min',
    popular: true,
  ...
  },
  {
    ...
    ingredients: ['Egyptian Hibiscus Flowers', 'Wild Blueberries', 'Mint', 'Elderflower Syrup'],
    allergens: ['None'],
    tags: ['Vegan', 'Caffeine-Free', 'Gluten-Free'],
    calories: 70,
    prepTime: '2 mins',
    popular: false,
  ...
  },
  {
    ...
    ingredients: ['Organic Sourdough', 'Hass Avocado', 'White Truffle Oil', 'Toasted Pepitas', 'Flaky Maldon Sea Salt'],
    allergens: ['Gluten (Sourdough)'],
    tags: ['100% Vegan', 'Organic', 'Savory Delights'],
    calories: 290,
    prepTime: '5-6 mins',
    popular: true,
  ...
  },
  {
    ...
    ingredients: ['70% Dark Fair Trade Chocolate', 'Roasted Peanuts', 'Maple Syrup', 'Himalayan Salt'],
    allergens: ['Peanuts'],
    tags: ['Vegan', 'Gluten-Free', 'Keto-Friendly Option'],
    calories: 220,
    prepTime: 'Instant',
    popular: false,
  ...
  },
  {
    ...
    ingredients: ['Artisanal Vanilla Bean Gelato', 'Fresh Double Shot Espresso', 'Dark Chocolate Curl'],
    allergens: ['Dairy'],
    tags: ['Italian Classic', 'Dessert & Coffee'],
    calories: 190,
    prepTime: '2 mins',
    popular: true,
