export const CAFE_INFO = {
  ...
  offers: [
    {
      code: "OAK15",
      discount: "15% Off Your First Online Order",
      minOrder: 10
    }, {
      code: "BREW20",
      discount: "20% Off Custom Coffee Builder Drinks",
      minOrder: 0
    }, {
      code: "MORNINGCOMBO",
      discount: "Free Pastry with any Large Specialty Latte (7 AM - 10 AM)",
      minOrder: 0
    }
  ],
  parking: {
    info: "Free 2-hour underground guest parking behind the cafe"
  }
};
